      ...
      <div className="bg-gray-500 text-white">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          ...
          <p className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
            <span  className="mr-2 cursor-pointer "><FaFacebook size={30} className="hover:size-7"/></span>
            <span className="mr-2 cursor-pointer "><FaInstagramSquare size={30} className="hover:size-7"/></span>
            <span className="mr-2 cursor-pointer "><FaTwitter size={30} className="hover:size-7"/></span>
             </p>
        </div>
      </div>
    </footer>
